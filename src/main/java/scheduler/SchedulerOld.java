 ...
 */
public class SchedulerOld implements Runnable {
	...
	/**
	 * Main method for the SchedulerOld class.
	 * @param args, default parameters
	 */
	public static void main(String[] args) {
		new Thread(new SchedulerOld()).start();
	}
	
	/**
	 * Constructor for the SchedulerOld.
	 */
	public SchedulerOld() {
	...
	/**
	 * SchedulerOld override run() method. Sleeps until the process is killed.
	 ...
	 * @return schedulerState SchedulerStateOld, current scheduler state
	 */
	public SchedulerStateOld getSchedulerState() {
	...
	/**
	 * Puts elevator request data into the SchedulerOld's reply queue.
	...
	/**
	 * SchedulerOld signals the elevator to move to the given location and register its new location
	 * @author Bobby Ngo
	...
	public synchronized void registerElevatorLocation(Integer id, Integer floorNumber) {
		...
		System.out.println(String.format("SchedulerOld: Elevator# %s current location: Floor %s", id, displayElevatorLocation(id)));
	}
